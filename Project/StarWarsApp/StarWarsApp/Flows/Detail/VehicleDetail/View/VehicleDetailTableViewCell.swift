...
class VehicleDetailTableViewCell: UITableViewCell {
    ...
    private func addSubviews() {
        ...
        let stackArray = [modelStackView, vehicleClassStackView, manufacturerStackView, costInCreditsStackView,
                          lengthStackView, crewStackView, passengersStackView, cargoCapacityStackView,
                          maxAtmospheringSpeedStackView, consumablesStackView]
